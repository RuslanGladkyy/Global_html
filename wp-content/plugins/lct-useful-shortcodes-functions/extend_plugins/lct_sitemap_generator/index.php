...
include_once( $this->plugin_dir_path . 'extend_plugins/lct_sitemap_generator/lang/' . $ddsg_lang_file . '.php' );
...
function ddsg_options_page() {
	...
	<form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
		...
		<p><?php echo DDSG_FOR_INFO; ?><br/>
			<a href="http://www.dagondesign.com/articles/sitemap-generator-plugin-for-wordpress/">http://www.dagondesign.com/articles/sitemap-generator-plugin-for-wordpress/</a>
		</p>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6">
			...
			<tr valign="top">
				...
				<td align="left">
					<select name="ddsg_language">
						...
						$language_list = [ ];
						$handle        = opendir( $g_lct->plugin_dir_path . 'extend_plugins/lct_sitemap_generator/lang' );
			...
			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_ITEMS_PER_PAGE; ?></th>
				<td valign="top">
			...
			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_SITEMAP_SLUG; ?></th>
				<td valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6">
			...
			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_SHOW; ?></th>
				<td valign="top">
					<input name="ddsg_what_to_show" type="radio" value="both" <?php if ( get_option( 'ddsg_what_to_show' ) == "both" )
						echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_SHOW_BOTH; ?>
					<br/>
					<input name="ddsg_what_to_show" type="radio" value="posts" <?php if ( get_option( 'ddsg_what_to_show' ) == "posts" )
						echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_SHOW_POSTS; ?>
					<br/>
					<input name="ddsg_what_to_show" type="radio" value="pages" <?php if ( get_option( 'ddsg_what_to_show' ) == "pages" )
						echo "checked='checked'"; ?>/>&nbsp;&nbsp; <?php echo DDSG_SHOW_PAGES; ?>
				</td>
			</tr>

			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_WHICH_FIRST; ?></th>
				<td valign="top">
					<input name="ddsg_which_first" type="radio" value="posts" <?php if ( get_option( 'ddsg_which_first' ) == "posts" )
						echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_WHICH_FIRST_POSTS; ?>
					<br/>
					<input name="ddsg_which_first" type="radio" value="pages" <?php if ( get_option( 'ddsg_which_first' ) == "pages" )
						echo "checked='checked'"; ?>/>&nbsp;&nbsp; <?php echo DDSG_WHICH_FIRST_PAGES; ?>
				</td>
			</tr>

			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_POST_SORT; ?></th>
				<td valign="top">
					<label><input name="ddsg_post_sort_order" type="radio" value="title" <?php if ( get_option( 'ddsg_post_sort_order' ) == "title" )
							echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_POST_SORT_T; ?>
						<br/></label>
					<label><input name="ddsg_post_sort_order" type="radio" value="datea" <?php if ( get_option( 'ddsg_post_sort_order' ) == "datea" )
							echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_POST_SORT_DA; ?>
						<br/></label>
					<label><input name="ddsg_post_sort_order" type="radio" value="dated" <?php if ( get_option( 'ddsg_post_sort_order' ) == "dated" )
							echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_POST_SORT_DD; ?>
						<br/></label>
				</td>
			</tr>

			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_PAGE_SORT; ?></th>
				<td valign="top">
					<label><input name="ddsg_page_sort_order" type="radio" value="title" <?php if ( get_option( 'ddsg_page_sort_order' ) == "title" )
							echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_PAGE_SORT_T; ?>
						<br/></label>
					<label><input name="ddsg_page_sort_order" type="radio" value="datea" <?php if ( get_option( 'ddsg_page_sort_order' ) == "datea" )
							echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_PAGE_SORT_DA; ?>
						<br/></label>
					<label><input name="ddsg_page_sort_order" type="radio" value="dated" <?php if ( get_option( 'ddsg_page_sort_order' ) == "dated" )
							echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_PAGE_SORT_DD; ?>
						<br/></label>
					<label><input name="ddsg_page_sort_order" type="radio" value="menua" <?php if ( get_option( 'ddsg_page_sort_order' ) == "menua" )
							echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_PAGE_SORT_MA; ?>
						<br/></label>
					<label><input name="ddsg_page_sort_order" type="radio" value="menud" <?php if ( get_option( 'ddsg_page_sort_order' ) == "menud" )
							echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_PAGE_SORT_MD; ?>
						<br/></label>
				</td>
			</tr>

			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_POST_COMMENTS; ?></th>
				<td valign="top">
					<input type="checkbox" name="ddsg_comments_on_posts" value="checkbox" <?php if ( get_option( 'ddsg_comments_on_posts' ) )
						echo "checked='checked'"; ?>/>
				</td>
			</tr>

			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_PAGE_COMMENTS; ?></th>
				<td valign="top">
					<input type="checkbox" name="ddsg_comments_on_pages" value="checkbox" <?php if ( get_option( 'ddsg_comments_on_pages' ) )
						echo "checked='checked'"; ?>/>
				</td>
			</tr>

			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_ZERO_COMMENTS; ?></th>
				<td valign="top">
					<input type="checkbox" name="ddsg_show_zero_comments" value="checkbox" <?php if ( get_option( 'ddsg_show_zero_comments' ) )
						echo "checked='checked'"; ?>/>
				</td>
			</tr>

			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_POST_DATES; ?></th>
				<td valign="top">
					<input type="checkbox" name="ddsg_show_post_date" value="checkbox" <?php if ( get_option( 'ddsg_show_post_date' ) )
						echo "checked='checked'"; ?>/>
				</td>
			</tr>

			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_PAGE_DATES; ?></th>
				<td valign="top">
					<input type="checkbox" name="ddsg_show_page_date" value="checkbox" <?php if ( get_option( 'ddsg_show_page_date' ) )
						echo "checked='checked'"; ?>/>
				</td>
			</tr>

			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_DATE_FORMAT; ?></th>
				<td valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6">
			...
			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_EXCLUDED_CATS; ?></th>
				<td valign="top">
			...
			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_EXCLUDED_PAGES; ?></th>
				<td valign="top">
					<textarea name="ddsg_excluded_pages" rows="20" cols="65"><?php echo get_option( 'ddsg_excluded_pages' ) ?></textarea><br/>
					- Page IDs, separated by commas OR new line<br/>
					- Sub-pages will also be excluded
				</td>
			</tr>

			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_HIDE_FUTURE; ?></th>
				<td valign="top">
					<input type="checkbox" name="ddsg_hide_future" value="checkbox" <?php if ( get_option( 'ddsg_hide_future' ) )
						echo "checked='checked'"; ?>/>
				</td>
			</tr>

			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_HIDE_PASS; ?></th>
				<td valign="top">
					<input type="checkbox" name="ddsg_hide_protected" value="checkbox" <?php if ( get_option( 'ddsg_hide_protected' ) )
						echo "checked='checked'"; ?>/>
				</td>
			</tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6">
			...
			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_NAV_METHOD; ?></th>
				<td valign="top">
					<label><input name="ddsg_page_nav" type="radio" value="1" <?php if ( get_option( 'ddsg_page_nav' ) == 1 )
							echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_NAV1_PAGE . ' 2 of 5 : <a href="#">' . DDSG_NAV1_PREV . '</a> : <a href="#">' . DDSG_NAV1_NEXT . '</a>'; ?>
						<br/></label>
					<label><input name="ddsg_page_nav" type="radio" value="2" <?php if ( get_option( 'ddsg_page_nav' ) == 2 )
							echo "checked='checked'"; ?>/>&nbsp;&nbsp; <?php echo DDSG_NAV2_PAGE . ' <a href="#">1</a> 2 <a href="#">3</a> <a href="#">4</a> <a href="#">5</a>'; ?>
					</label>
				</td>
			</tr>
			...
			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_NAV_WHERE; ?></th>
				<td valign="top">
					<label><input name="ddsg_page_nav_where" type="radio" value="top" <?php if ( get_option( 'ddsg_page_nav_where' ) == "top" )
							echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_NAV_WHERE_TOP; ?>
						<br/></label>
					<label><input name="ddsg_page_nav_where" type="radio" value="bottom" <?php if ( get_option( 'ddsg_page_nav_where' ) == "bottom" )
							echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_NAV_WHERE_BOT; ?>
						<br/></label>
					<label><input name="ddsg_page_nav_where" type="radio" value="both" <?php if ( get_option( 'ddsg_page_nav_where' ) == "both" )
							echo "checked='checked'"; ?>/>&nbsp;&nbsp; <?php echo DDSG_NAV_WHERE_BOTH; ?>
					</label>
				</td>
			</tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6">
			...
			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_XML_PATH; ?></th>
				<td valign="top">
			...
			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_XML_WHERE; ?></th>
				<td valign="top">
					<label><input name="ddsg_xml_where" type="radio" value="last" <?php if ( get_option( 'ddsg_xml_where' ) == 'last' )
							echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_XML_WHERE_LAST; ?>
						<br/></label>
					<label><input name="ddsg_xml_where" type="radio" value="every" <?php if ( get_option( 'ddsg_xml_where' ) == 'every' )
							echo "checked='checked'"; ?>/>&nbsp;&nbsp; <?php echo DDSG_XML_WHERE_EVERY; ?>
					</label>
				</td>
			</tr>

			<tr>
				<th width="45%" valign="top" align="right" scope="row"><?php echo DDSG_NEW_WINDOW; ?></th>
				<td valign="top">
					<input type="checkbox" name="ddsg_new_window" value="checkbox" <?php if ( get_option( 'ddsg_new_window' ) )
						echo "checked='checked'"; ?>/>
				</td>
			</tr>
	...
	while( isset( $pages[ $k ] ) && ( $pages[ $k ]->post_parent == $parent ) && ( $k < $num_pages ) ) {
		...
		if ( in_array( $pages[ $k ]->ID, $excluded_pages, false ) === false ) {
			...
			if ( $comments_on_pages )
				$tmp_array['comments'] = $pages[ $k ]->comment_count;
			if ( $show_page_date )
				$tmp_array['date'] = $pages[ $k ]->post_date;
			$page_data[] = $tmp_array;
		}
...
function ddsg_merge_cats_posts( $post_data, $posts, $cat_data, $num_posts, $num_cats, $comments_on_posts, $show_post_date ) {
	...
	for ( $c = 0; $c < $num_cats; $c ++ ) {
		...
		while( isset( $posts[ $k ] ) && ( $posts[ $k ]->category_id == $cat_data[ $c ]['cat_id'] ) && ( $k < $num_posts ) ) {
			...
			if ( $comments_on_posts )
				$tmp_array['comments'] = $posts[ $k ]->comment_count;
			if ( $show_post_date )
				$tmp_array['date'] = $posts[ $k ]->post_date;
			$post_data[] = $tmp_array;
...
function ddsg_create_sitemap() {
	...
	$excluded_pages    = preg_replace( '/(\r\n|\n|,)+/', ',', $excluded_pages );
	$excluded_pages    = preg_replace( '/\[(.*?)\]/', '', $excluded_pages );
	//ENDzz
